...
public class Model {
    ...
    public void simulate(double time) {
        ...
        while (tcurr < time) {
            ...
            printInfo();
            double fullLoading = ((Process) list.get(2)).getQueueLoading() / tcurr;
            int maxBuffer = Process.getMaxObservedSharedQueue();
            double probability = (double) (list.get(0).getQuantity() - list.get(1).getQuantity() + list.get(1).getState()) / list.get(0).getQuantity();
